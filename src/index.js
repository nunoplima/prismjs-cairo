function cairo(Prism) {
  ...
  Prism.languages.cairo["closure-params"].inside.rest = Prism.languages.cairo;
  Prism.languages.cairo["attribute"].inside["string"] =
    Prism.languages.cairo["string"];
}

cairo.displayName = "cairo";
